 ...
 *
 * Run with: --map-by ppr:1:node, 4 nodes minimum. Requires NCCL_CUMEM_ENABLE=1.
...
protected:
    ...
    bool setUpLsaDevComm(int nBarriers, ncclComm_t* commOut,
        ...
        skipReason_.clear();
        // Require at least 4 ranks across at least 2 nodes (1 rank/node).
        // With 1 rank/node: lsaTeam.nRanks = nNodes, each rank waits for nNodes-1
