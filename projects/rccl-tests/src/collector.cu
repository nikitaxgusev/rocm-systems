...
static const CounterRegistryEntry counter_registry[] = {
  ...
  {"rx_cnp_pkts",             COUNTER_SRC_IB_HW,    false,  NULL,            true,       "rx_rdma_cnp_pkts",     COUNTER_SRC_IB_HW},
  {"tx_cnp_pkts",             COUNTER_SRC_IB_HW,    false,  NULL,            true,       "tx_rdma_cnp_pkts",     COUNTER_SRC_IB_HW},
...
static void CollectEthtoolCounters(const std::string& nic,
  ...
  // prefix pairs: (ethtool_prefix, canonical_prefix)
